                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        {!!email
                            ...
                            :   <div className={styles['error-container']}>
                                    <Input type={'text'} className={'big-input'} error={errors?.email?.message} touched={touchedFields.email} register={register} name={'email'} patternValue={/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/} minLength={10} maxLength={20} placeholder={'Your email'}/>
                                </div>
                        }
