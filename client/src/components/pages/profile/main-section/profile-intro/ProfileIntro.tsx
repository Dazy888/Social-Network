...
const ProfileIntroComponent: React.FC<Props> = ({ aboutMe, hobbies, skills, forView = false, id }) => (
    <article className={styles['profile-intro']}>
        ...
        <ProfileIntroItem {...{ id, forView }} title={'Hobbies'} field={'skills'} currentText={skills || 'Write your skills here.'} />
        <ProfileIntroItem {...{ id, forView }} title={'Skills'} field={'hobbies'} currentText={hobbies || 'Tell people about your hobbies here.'} />
    </article>
)
